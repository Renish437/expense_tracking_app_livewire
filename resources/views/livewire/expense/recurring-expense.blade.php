<div class="min-h-screen bg-gray-50 dark:bg-neutral-800  ">
    ...
    <div class="bg-primary-gradient shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <a href="/expenses/create" class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-lg font-semibold  backdrop-blur-sm flex items-center gap-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        @if (session()->has('message'))
            <div class="mb-6 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-200 px-4 py-3 rounded-lg flex items-center justify-between">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-blue-500 ">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Active Recurring</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-purple-500 ">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Monthly Total</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-green-500 ">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Generated This Month</p>
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">
                          {{ $generatedThisMonth }}
                        </p>
                    </div>
        ...
        @if($recurringExpenses->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($recurringExpenses as $expense)
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl ">
                        <!-- Card Header -->
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($expense->category)
                                      <div class="flex gap-2 text-white">
                                        ...
                                        <div class="flex gap-2 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm text-white">
                                             @if ($expense->category && $expense->category->icon)
                                                <flux:icon :name="$expense->category->icon" class="w-6 h-6 text-[{{ $expense->category->color }}]" />
                                            @else
                                                <flux:icon name="tag" class="w-5 h-5 text-white" />
                                            @endif
                        ...
                        <div class="p-6 space-y-4 text-gray-700 dark:text-gray-300">
                            ...
                            <div class="space-y-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                                ...
                                @else
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-gray-600 dark:text-gray-400">Ends</span>
                                        <span class="font-medium text-gray-600 dark:text-gray-400">Never</span>
                                    </div>
                                @endif
                            </div>
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-12 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">Set up recurring expenses like subscriptions, rent, or utilities to track them automatically.</p>
                <a href="/expenses/create" class="inline-flex items-center gap-2 bg-primary-gradient text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg ">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>

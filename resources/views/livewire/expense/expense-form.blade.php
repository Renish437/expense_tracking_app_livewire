        ...
        <form wire:submit="save" class="space-y-8">
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl p-8 border border-neutral-200 dark:border-neutral-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Amount -->
                    <div>
                        <label for="amount" class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-2">
                            Amount <span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-neutral-500 dark:text-neutral-400 text-lg">$</span>
                    ...
                    <!-- Date -->
                    <div>
                        <label for="date" class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                            Don't see your category? <a href="/categories" class="text-purple-500 dark:text-purple-400 font-medium hover:underline cursor-pointer">Create one</a>
                        </p>
                    </div>
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl p-8 border border-neutral-200 dark:border-neutral-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- One-time -->
                    <label class="relative flex items-center p-5 border-2 rounded-xl cursor-pointer transition
                        {{ $type === 'one-time'
                ...
                @if($type === 'recurring')
                    <div class="p-6 bg-purple-50 dark:bg-purple-900/30 rounded-xl border-2 border-purple-200 dark:border-purple-700">
                        ...
                        <div class="mt-4 flex items-start gap-3 text-sm text-purple-800 dark:text-purple-300">
                            ...
                            <div>
                                <strong>Note:</strong> This expense will auto-generate entries based on your frequency. Scheduler runs nightly.
                            </div>
                        </div>
                    </div>
                @endif
